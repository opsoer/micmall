...
func List(ctx *gin.Context) {
	...
	rsp, err := global.MessageClient.MessageList(context.WithValue(context.Background(), "ginContext", ctx), request)
	if err != nil {
		zap.S().Errorw("获取留言失败")
...
func New(ctx *gin.Context) {
	...
	rsp, err := global.MessageClient.CreateMessage(context.WithValue(context.Background(), "ginContext", ctx), &proto.MessageRequest{
